CREATE MATERIALIZED VIEW mv_liquidity AS (
    ...
    liquidity_with_base_metrics AS (
        SELECT 
            ...
            COALESCE(bot_tour_SNG.bot_SNG_tournaments, 0) AS bot_SNG_tournaments,
            COALESCE(bot_tour_SNG.bot_SNG_participants, 0) AS bot_SNG_participants,
            ...
            COALESCE(bot_tour_MTT.bot_MTT_tournaments, 0) AS bot_MTT_tournaments,
            COALESCE(bot_tour_MTT.bot_MTT_participants, 0) AS bot_MTT_participants,
